...
from dataset.CannyControlNetDataset import CannyControlNetDataset
...
with open('train_neg_canny_pix2pix.yaml', 'r') as file:
...
# Dataset and Dataloader setup
train_dataset = CannyControlNetDataset(config['dataset']['path_processed'],
                            data_file=config['dataset']['data_file'],
                            source=config['dataset']['source'],
                            target=config['dataset']['target'],
                            prompt=config['dataset']['prompt'],
...
# Dataset and Dataloader setup
val_dataset = CannyControlNetDataset(config['dataset']['path_processed'],
