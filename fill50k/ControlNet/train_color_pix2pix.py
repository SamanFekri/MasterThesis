...
from dataset.ColorControlNetDataset import ColorControlNetDataset
...
with open('train_color_pix2pix_lite.yaml', 'r') as file:
...
# Dataset and Dataloader setup
train_dataset = ColorControlNetDataset(config['dataset']['path_processed'],
                            data_file=config['dataset']['data_file'],
                            source=config['dataset']['source'],
                            target=config['dataset']['target'],
                            prompt=config['dataset']['prompt'],
...
# Dataset and Dataloader setup
val_dataset = ColorControlNetDataset(config['dataset']['path_processed'],
